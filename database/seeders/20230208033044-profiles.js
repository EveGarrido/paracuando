...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    try {
      const adminUser1 = await usersService.findUserByEmailOr404('evelyn.harleth.gl@@academlo.com')
      const adminUser2 = await usersService.findUserByEmailOr404('daniel.martinez.b11@academlo.com')
